...
class ResNet(nn.Module):
    def __init__(self, bottleneck=False, baseWidth=64, head7x7=True, layers=(3, 4, 23, 3), num_classes=1000):
        ...
        self.conv1_ls = nn.Conv2d(in_channels=baseWidth * 8 * block.expansion, out_channels=1, kernel_size=3)
...
def resnet12():
    model = ResNet(bottleneck=False, baseWidth=64, head7x7=True, layers=(2, 1, 1, 1), num_classes=1000)
    return model
